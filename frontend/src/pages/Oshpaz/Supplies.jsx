...
export default function OshpazSupplies() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/oshpaz/supplies/request', {
        items: [{
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="Masalan: Maxsus ziravorlar, Zaytun yog'i..." 
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Miqdori (kg/dona/litr)</label>
            <input 
              type="number" 
              min="1"
