...
import { Loader2, AlertCircle, ShoppingCart, CheckCircle2, Edit3 } from 'lucide-react';
import api from '../../lib/api';

const PREDEFINED_ITEMS = [
  "Lampochka (LED)",
  "Rozetka",
  "Kran rezinkasi (Prokladka)",
  "Santehnika lentasi (Fum lenta)",
  "Batareyka (AA)",
  "Batareyka (AAA)",
  "Silikon",
  "Pena",
...
export default function UstaSupplies() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/usta/supplies/request', {
        items: [{
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Usta uchun kerakli anjomlar va asbob-uskunalarga buyurtma berish.</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="Masalan: Maxsus asbob..." 
